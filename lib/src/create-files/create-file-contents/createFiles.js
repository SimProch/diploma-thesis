...
var resultPath = calledFromPath + "/result";
function createTsInterface(interfaceName, props) {
    return new Promise(function (resolve, reject) {
        ...
        var filePath = resultPath + "/" + interfaceName + ".ts";
...
function createCsModel(modelName, props) {
    return new Promise(function (resolve, reject) {
        ...
        var filePath = resultPath + "/" + modelName + ".cs";
        createResultDirectory();
        deleteFileIfExists(filePath);
        var getModelArgs = {
            modelName: modelName,
...
function createDataAccess(methodType, schema, spName, props, modelProps) {
    return new Promise(function (resolve, reject) {
        var filePath = resultPath + "/" + spName + ".cs";
        createResultDirectory();
        deleteFileIfExists(filePath);
        var dataAccessArgs = {
...
function createController(args) {
    return new Promise(function (resolve, reject) {
        var filePath = resultPath + "/" + args.classMethodName + ".cs";
        createResultDirectory();
        deleteFileIfExists(filePath);
