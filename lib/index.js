...
var generate_1 = require("./create-files/generate");
var databaseConnection_1 = require("./database-connection/databaseConnection");
var listDatabases_1 = require("./database-connection/listDatabases");
...
var listSchemas_1 = require("./database-connection/listSchemas");
var listStoredProcedures_1 = require("./database-connection/listStoredProcedures");
...
function getRegenrateCommand(yargs) {
    return yargs.command("regenerate", "List ", function (yargs) {
        return yargs
            .option("storedProcedureName", {
            string: true,
