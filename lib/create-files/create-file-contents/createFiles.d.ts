...
export declare function createTsInterface(interfaceName: string, props: InterfaceProperties[]): Promise<string>;
export declare function createCsModel(modelName: string, props: ModelProperties[]): Promise<string>;
