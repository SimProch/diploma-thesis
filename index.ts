...
import { generate } from "./src/create-files/generate";
import { initSqlConfig } from "./src/database-connection/databaseConnection";
import { listDatabases } from "./src/database-connection/listDatabases";
import { listProcedureInput } from "./src/database-connection/listProcedureInput";
import { listProcedureOutput } from "./src/database-connection/listProcedureOutput";
import { listSchemas } from "./src/database-connection/listSchemas";
import { listStoredProcedures } from "./src/database-connection/listStoredProcedures";
import { CommandArguments, GlobalConfiguration, MethodCallType } from "./src/types/cli.types";
